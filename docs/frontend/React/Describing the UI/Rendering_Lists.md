...
const people1_8_1 = [
  ...
  export default function List1_8_1() {
    const listItems = people1_8_1.map(person =>
      <li>{person}</li>
    );
    return <ul>{listItems}</ul>;
  }
...
```tsx
export function getImageUrl1_8_1(person) {
...
```jsx
export default function List1_8_2() {
...
```tsx
export function getImageUrl1_8_2(person) {
  return "https://i.imgur.com/" + person.imageId + "s.jpg";
}
```
</TabItem>
