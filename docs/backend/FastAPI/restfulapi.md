...
FastAPI 使定义这些 RESTful 风格的 URL 变得异常简单。
:::

希望这个简短示例能让你理解 FastAPI 中的资源和嵌套路由!
...
更详细请见[HTTP响应状态码](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Status)
:::
